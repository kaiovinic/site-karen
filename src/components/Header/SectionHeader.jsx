...
const SectionHeader = () => {
  return (
    <>
      ...
      max-lg:top-[70%] max-lg:left-[50%] max-lg:-translate-x-1/2 max-lg:-translate-y-1/2 max-sm:hidden 
      max-lg:landscape:hidden"
        data-scroll
        id="sobre"
      >
        <h1 className="text-4xl font-bold wrap text-[#816e26] max-sm:text-xl max-sm:text-center">
